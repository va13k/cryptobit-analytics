...
<?php
    ...
    require($_SERVER['DOCUMENT_ROOT']."/website_files/php/EN/includes/cryptocurrency.php");
?>

<div class="intropart" style="background-image: url(http://cryptobitanalytics/jpg_png_images/articles.jpg);">
        <center><p class="introText">Articles and news</p></center>
</div>
...
<aside class="aside">
        <div class="cryptocurrency-table">
            <table class="table table-bordered">
                <tr>
                    ...
                    <center>Cryptocurrency rates</center></td>
                </tr>
                <tr>
                    <th>Bitcoin</th>
    ...
    <a href="http://cryptobitanalytics/website_files/php/EN/includes/single.php?id=<?php $article_id = $article['id']; echo $article["id"]; ?>">
    ...
    <div class="otherNews">
        <div class="container">
        <br>
            <center><p class="whiteTitle">Other news sites</p></center>
        <br>
        <div class="row">
