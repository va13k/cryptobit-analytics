...
<section class="ServicesMain">
    <div class="intropart" style="background-image: url(http://cryptobitanalytics/jpg_png_images/services.jpg);">
        <center><p class="introText">Services</p></center>
    </div>
    ...
    <?php 
		...
		foreach ($services as $service): ?>
                ...
                <div class="card col-6 col-md-4">
                    ...
                    <hr>
                        <div class="details">
                            <p class="card-details"><b>Duration of execution:</b> <?php echo $service["complation_time"]; ?></p> 
                            <p class="card-details"><b>Result:</b> <?php echo $service["result"]; ?></p>
                            <p class="card-details"><b>Cost:</b> <?php echo $service["price"]; ?></p>
                        </div>
                    </div>
                    <button type="button" class="btn btn-outline-primary mt-auto stretched-link" data-toggle="modal" data-target=".bd-example-modal-lg">Order</button>
...
<section class="Contacts">
    <div class="container">
      ...
      <br><center><p class="blueTitle">Contact Us</p></center><br>
      ...
      <form action="http://cryptobitanalytics/telegramEN.php" method="POST">
        <div class="center">
          <div class="form-group col-12 col-sm-12 col-md-8 col-lg-8 mx-auto">
            ...
            placeholder="Enter phone number" required minlength="11" maxlength="15">
            <br>
...
<section class="ourClients">
    <div class="container">
        <br>
        <center><p class="whiteTitle">Our customers</p></center>
        <br>
        <div class="row">
