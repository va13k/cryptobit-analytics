...
<div class="intropart" style="background-image: url(http://cryptobitanalytics/jpg_png_images/contacts.jpg); background-size: 1520px;">
  <div class="text-intro">
    <p class="introtext">Связаться с Cryptobit Analytics</p>
  </div>
</div>
      ...
      <form action="http://cryptobitanalytics/telegram.php" method="POST">
        <div class="center">
          <div class="form-group col-12 col-sm-12 col-md-8 col-lg-8 mx-auto">
            ...
            <br>
            <input id="phone" step="any" type="text" name="user_phone" class="form-control form-control-lg" placeholder="Введите номер телефона" value="" required minlength="11" maxlength="15">
            <br>
