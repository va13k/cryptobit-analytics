...
<?php
    ...
    require($_SERVER['DOCUMENT_ROOT']."/website_files/php/UA/includes/cryptocurrency.php");
?>

<div class="intropart" style="background-image: url(http://cryptobitanalytics/jpg_png_images/articles.jpg);">
        <center><p class="introText">Статті і новини</p></center>
</div>
...
<aside class="aside">
    ...
    <a href="http://cryptobitanalytics/website_files/php/UA/includes/single.php?id=<?php $article_id = $article['id']; echo $article["id"]; ?>">
    ...
    <div class="otherNews">
        <div class="container">
        <br>
            <center><p class="whiteTitle">Інші новинні майданчики</p></center>
        <br>
        <div class="row">
