...
<head>
	...
	<link rel="stylesheet" type="text/css" href="website_files/style.css">
	<link rel="stylesheet" type="text/css" href="website_files/style320px.css">
...
<body>
	<header class="sticky-top">
		<nav class="navbar sticky-top navbar-expand-lg navbar-gray-dark bg-gray-dark">
			...
			<a class="navbar-brand pull-sm-left" href="index.php">
				<img class="nav-brand" src="svg_images/main_logo.svg" alt="logo">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbar1">
				<div class="nav-links mx-auto">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="website_files/aboutUsRU.php">О нас</a></li>
				...
				<ul class="navbar-nav ml-auto" id="dropdown">
					<li class="nav-item dropdown">
						<button class="nav-link dropdown-toggle" id="navbarDropdownMenuLink"
							...
							aria-haspopup="true" aria-expanded="false">RU
						</button>
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="indexEn.php" id="navbarDropdownMenuLink Lang-En">
								<img width="30" height="20" alt="en" id="Lang-En" src="svg_images/Great_Britain.svg">EN
							</a>
